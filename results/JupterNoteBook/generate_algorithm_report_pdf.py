...
MARKDOWN_PATH = BASE_DIR / "algorithm_comparison_report.md"
PDF_PATH = BASE_DIR / "algorithm_comparison_report.pdf"
...
styles.add(ParagraphStyle(name="BulletBody", parent=styles["BodyText"], leftIndent=14, leading=13, spaceAfter=2))
...
def build_story(markdown_text: str):
    ...
    story = [Paragraph("Algorithm Comparison Report", styles["TitleCenter"]), Spacer(1, 0.12 * inch)]
    i = 0
    buffer = []
